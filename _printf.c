 ...
 * @format: argument for printing format
...
/**
 * print_buffer - funct that prints the content of the buffer
 * @buffer: argument containing array of characters
 * @buff_ind: Index to work on
 */
void print_buffer(char buffer[], int *buff_ind)
{
	if (*buff_ind > 0)
